...
@Value.Style(get = {"is*", "get*"}, init = "set*", typeAbstract = "Base*", typeImmutable = "*", visibility = Value.Style.ImplementationVisibility.PACKAGE)
public @interface PackagePrivateImmutablesStyle {
}
